...
const DIFFICULTY_MODIFIERS: Dictionary = {
	...
	Difficulty.NORMAL: { "coin": 1.3, "train_time": 0.95, "upgrade_speed": 1.15, "push_ratio": 1.4, "defend_ratio": 0.5, "retaliation": 0.6, "smarts": 2, "wave": 1.0, "snowstorm_speed": 0.8, "snowstorm_interval": 1.0, "snowstorm_damage": 1.0, "volcano_interval": 1.0, "volcano_damage": 1.0, "volcano_duration": 1.0, "volcano_meteor_rate": 1.0 },
	Difficulty.HARD: { "coin": 1.55, "train_time": 0.8, "upgrade_speed": 1.45, "push_ratio": 1.2, "defend_ratio": 0.35, "retaliation": 0.8, "smarts": 3, "wave": 0.85, "snowstorm_speed": 0.6, "snowstorm_interval": 0.8, "snowstorm_damage": 1.3, "volcano_interval": 0.8, "volcano_damage": 1.3, "volcano_duration": 1.15, "volcano_meteor_rate": 1.25 },
	Difficulty.NIGHTMARE: { "coin": 1.9, "train_time": 0.65, "upgrade_speed": 1.8, "push_ratio": 1.1, "defend_ratio": 0.2, "retaliation": 1.0, "smarts": 3, "wave": 0.7, "snowstorm_speed": 0.5, "snowstorm_interval": 0.65, "snowstorm_damage": 1.6, "volcano_interval": 0.65, "volcano_damage": 1.65, "volcano_duration": 1.25, "volcano_meteor_rate": 1.45 },
...
#   tower_save:          rush openers never save for a tower (army first);
#                        towers still come organically from surplus.
const AI_OPENERS: Dictionary = {
	"balanced": { "wave_threshold_mult": 1.0, "miner_delta": 0, "tower_first": false },
	"rush": { "wave_threshold_mult": 0.7, "miner_delta": -1, "tower_first": false, "tower_save": false },
